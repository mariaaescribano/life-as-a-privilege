-- Tabla de los VÍDEOS (shorts de YouTube) de la sección «Vídeos».
-- Ejecútalo una vez en el SQL editor de Supabase.
--
-- Aquí no se aloja ningún vídeo: solo el enlace al short, la portada que subes
...
create table if not exists public.video (
  ...
  url         text not null default '',       -- enlace al short de YouTube
