...
# ERA · ¿Qué significa estar enfermo?

`key: prologo` · Época: **Antes de hablar de culturas**

---

## 1 · ¿Qué es una enfermedad?

`que-es-enfermedad` · **La pregunta de siempre**
...
## 2 · Los cuatro tipos de enfermedad

`cuatro-tipos` · **Una brújula para entenderlas**
...
## 3 · Las tres formas de curar

`tres-formas-curar` · **El mapa completo**
...
## 4 · ¿Qué haces tú cuando enfermas?

`que-haces-tu` · **sin fecha**
...
`key: chaman` · Época: **Prehistoria**

---

## 1 · Los primeros sanadores

`primeros-sanadores` · **Hace más de 20.000 años**
...
## 2 · El ritual y la esperanza

`ritual-esperanza` · **La primera medicina**
...
## 3 · El poder de la mente: el placebo

`placebo` · **Un descubrimiento eterno**  ·  1 pág. Profundiza
...
### Profundiza 1 · Cómo funciona el placebo (y qué no puede hacer)
...
## 5 · Aplícalo a tu vida

`chaman-aplicalo` · **sin fecha**
...
# ERA · Egipto: observar la naturaleza

`key: egipto` · Época: **≈3000-500 a. C.**
...
## 2 · Los papiros médicos

`papiros-medicos` · **≈1600 a. C.**
...
`higiene-dieta` · **El cuidado cotidiano**
...
## 4 · Los primeros especialistas

`especializacion` · **Médicos por órganos**
...
# ERA · India: el equilibrio

`key: india` · Época: **≈1500 a. C. en adelante**

---

## 1 · Charaka

`charaka` · **≈siglo II a. C.**
...
## 3 · Los doshas y la constitución

`doshas` · **El corazón del Ayurveda**
...
## 4 · Cinco elementos y yoga

`cinco-elementos-yoga` · **Cuerpo, mente y entorno**
...
# ERA · China: la energía

`key: china` · Época: **≈2000 a. C. en adelante**

---

## 1 · El Huangdi Neijing

`huangdi-neijing` · **≈siglo III-II a. C.**
...
## 2 · El Qi y el Yin-Yang

`qi-yinyang` · **La energía y sus opuestos**
...
## 3 · Meridianos y acupuntura

`meridianos-acupuntura` · **La medicina de las agujas**
...
`cinco-elementos-chinos` · **Todo está conectado**
...
# ERA · Grecia: nace la medicina racional

`key: grecia` · Época: **≈siglo V a. C.**
...
## 2 · La teoría de los cuatro humores

`cuatro-humores` · **El modelo que duró siglos**  ·  1 pág. Profundiza
...
### Profundiza 1 · Por qué una teoría falsa duró dos mil años
...
## 4 · Herófilo y Erasístrato

`herofilo-erasistrato` · **≈siglo III a. C.**
...
# ERA · Galeno y Roma: ordenar el cuerpo

`key: galeno-roma` · Época: **≈siglo II d. C.**
...
## 2 · Anatomía y función de los órganos

`anatomia-organos` · **Entender la máquina**
...
## 3 · Roma y la salud pública

`roma-salud-publica` · **Curar a un pueblo entero**
...
## 4 · El error que duró 1500 años

`error-1500-anios` · **sin fecha**
...
# ERA · El mundo islámico

`key: islam` · Época: **≈siglos VIII-XIII**
...
## 6 · Los primeros hospitales

`hospitales` · **El bimaristán**
...
## 7 · Método clínico y humanismo

`metodo-humanismo` · **El médico trata personas**
...
## 8 · Aplícalo a tu vida

`islam-aplicalo` · **sin fecha**
...
# ERA · Renacimiento: mirar dentro

`key: renacimiento` · Época: **Siglos XVI-XVII**
...
## 4 · Hooke y el microscopio

`hooke-microscopio` · **1665**
...
## 6 · Aplícalo a tu vida

`renacimiento-aplicalo` · **sin fecha**
...
# ERA · La revolución científica

`key: revolucion-cientifica` · Época: **Siglos XVII-XVIII**
...
`metodo-cientifico` · **La gran herramienta**  ·  1 pág. Profundiza
...
### Profundiza 1 · El ensayo clínico: el invento que separa lo que cura de lo que no
...
# ERA · Los microbios cambian el mundo

`key: microbios` · Época: **Siglos XVIII-XIX**

---

## 1 · Edward Jenner

`jenner` · **1749-1823**  ·  1 pág. Profundiza
...
### Profundiza 1 · Cómo funciona una vacuna, y cómo se borró una enfermedad
...
## 3 · John Snow y el mapa del cólera
...
## 7 · Higiene y esterilización

`higiene-esterilizacion` · **Salvar vidas con jabón**
...
# ERA · La medicina moderna

`key: medicina-moderna` · Época: **Siglos XIX-XX**
...
## 2 · Los rayos X y ver por dentro
...
`fleming` · **1881-1955**  ·  1 pág. Profundiza
...
### Profundiza 1 · Lo que hay que saber sobre los antibióticos
...
**Dato curioso:** cuando la penicilina era escasísima y carísima, en los hospitales militares se recuperaba de la orina de los pacientes tratados para volver a purificarla y reutilizarla. No se podía desperdiciar ni una gota.

---

## 5 · Cannon y la homeostasis

`cannon-homeostasis` · **El equilibrio interior**
...
## 6 · Osler y el hospital moderno

`osler-hospital` · **Aprender junto al enfermo**
...
`especializacion-moderna` · **Saber mucho de poco**
...
## 8 · El ADN y la genética

`adn-genetica` · **1953-2003**
...
## 10 · Pandemias y vacunas de ARN

`pandemias-arn` · **2020-2023**
...
## 11 · Aplícalo a tu vida

`moderna-aplicalo` · **sin fecha**
...
# ERA · La psiquiatría: curar la mente

`key: psiquiatria` · Época: **Siglos XIX-XX**

---

## 1 · La locura, de la posesión a la enfermedad

`locura-historia` · **Durante casi toda la historia**
...
## 4 · El nacimiento de los psicofármacos

`psicofarmacos` · **Desde 1950**  ·  1 pág. Profundiza
...
### Profundiza 1 · Lo que se hizo antes de la pastilla
...
**Dato curioso:** el litio, que sigue siendo uno de los tratamientos más eficaces que existen para el trastorno bipolar, es un elemento químico simple, no una molécula diseñada en un laboratorio. Uno de los mejores medicamentos de la psiquiatría es, literalmente, un metal de la tabla periódica.

---

## 5 · Aplícalo a tu vida

`psiquiatria-aplicalo` · **sin fecha**
...
# ERA · La medicina integrativa

`key: integrativa` · Época: **Siglos XX-XXI**

---

## 1 · ¿Qué es la medicina integrativa?

`que-es-integrativa` · **El reencuentro**  ·  1 pág. Profundiza
...
### Profundiza 1 · Cómo distinguir lo que funciona de lo que se vende
...
**Dato curioso:** hay un tratamiento que aparece en casi todas las guías clínicas modernas, no tiene efectos secundarios, es gratis y ninguna cultura de este recorrido lo ignoró: el movimiento. Hipócrates ya lo receta, el Ayurveda y la medicina china lo prescriben, y la investigación actual lo confirma como una de las intervenciones más eficaces que tenemos.

---

## 2 · Los pilares del cuidado

`pilares-integrativa` · **Nutrición, mente y estilo de vida**
...
## 4 · Inspiraciones y matices

`avicena-steiner` · **Avicena y Steiner**
