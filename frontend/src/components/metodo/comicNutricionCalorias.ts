...
//
// Imágenes: /viñetas/nutricion/calorias/nutricalorias1.png … nutricalorias7.png
// (mientras no existan, el ComicViewer pinta un placeholder «próximamente»).
export const NUTRICION_CALORIAS: Vineta[] = [
  {
    src: "/viñetas/nutricion/calorias/nutricalorias1.png",
    paragraphs: [
  ...
  {
    src: "/viñetas/nutricion/calorias/nutricalorias2.png",
    paragraphs: [
  ...
  {
    src: "/viñetas/nutricion/calorias/nutricalorias3.png",
    paragraphs: [
  ...
  {
    src: "/viñetas/nutricion/calorias/nutricalorias4.png",
    paragraphs: [
      ...
      "La energía no es una molécula, pero el ATP funciona como una pequeña batería recargable que la transporta allí donde hace falta.",
    ],
  },
  {
    src: "/viñetas/nutricion/calorias/nutricalorias5.png",
    paragraphs: [
  ...
  {
    src: "/viñetas/nutricion/calorias/nutricalorias6.png",
    paragraphs: [
  ...
  {
    src: "/viñetas/nutricion/calorias/nutricalorias7.png",
    paragraphs: [
