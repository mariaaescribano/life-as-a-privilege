...
// Icono de «Herida» (estilo Material Symbols), en el color de la disciplina.
export const HeridaIcon = ({
  size = 24,
  color = "currentColor",
  opacity = 1,
}: {
