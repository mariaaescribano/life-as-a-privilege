...
//
// VOZ: las cuatro primeras viñetas son la parte científica y van en «nosotros»
// / impersonal; la quinta, que es el cierre, va entera en «tú». Dentro de una
// misma viñeta NO se mezclan las dos personas.
//
...
export const COMIC_HERENCIA: Vineta[] = [
  {
    ...
    paragraphs: [
      ...
      "El ambiente, nuestras respuestas internas, el estrés, la alimentación o determinadas experiencias pueden influir en la expresión génica.",
    ],
  },
  {
  ...
  },
  {
    ...
    titulo: "",
    paragraphs: [
      "Aquí aparece el concepto de trauma transgeneracional.",
      "Se utiliza para estudiar cómo las consecuencias de experiencias traumáticas pueden aparecer o transmitirse entre generaciones.",
      "Existen diferentes mecanismos posibles por los que los traumas de nuestros ancestros pueden perdurar en nosotros.",
      "Algunos investigadores estudian cambios biológicos y epigenéticos, mientras que otros destacan la transmisión familiar de comportamientos, emociones, formas de crianza y respuestas al estrés.",
  ...
  },
  {
    ...
    titulo: "",
    paragraphs: [
      "El trauma también puede transmitirse de manera psicológica y social.",
      "Una persona que ha vivido experiencias traumáticas puede desarrollar determinadas formas de relacionarse con sus hijos, por ejemplo, mediante miedo, sobreprotección, silencio emocional o dificultad para confiar.",
  ...
  },
  {
    ...
    titulo: "",
    paragraphs: [
      "Sin embargo, una historia familiar no determina tu futuro. Comprender los patrones familiares, recibir apoyo y trabajar las experiencias traumáticas puede ayudarte a modificar la manera en que respondes ante ellas.",
      "Lo que ocurrió en tu familia forma parte de tu historia, pero no tiene por qué decidir cómo será tu futuro.",
    ],
  },
];
