...
export const CABALA_INTRO: Vineta[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Y el Kli, la Vasija, la energía femenina, cuya naturaleza es recibir, contener y manifestar esa luz.",
      "Ambos no eran seres distintos, sino dos aspectos inseparables de lo mismo.",
    ],
  },
  {
