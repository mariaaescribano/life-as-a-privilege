...
interface PagoNutricionModalProps {
  isOpen: boolean;
  onClose: () => void;
  onPagar: () => void;
  loading?: boolean;
...
/** Pago de la 6ª disciplina (Nutrición). Mismo lenguaje que PagoFisiologiaModal. */
export function PagoNutricionModal({ isOpen, onClose, onPagar, loading, error, onTest }: PagoNutricionModalProps) {
  return (
        ...
        <ModalBody px={{ base: 7, md: 10 }} py={{ base: 8, md: 10 }}>
          <Flex direction="column" gap={5}>
            ...
            <Text
              ...
              textAlign="center"
            >
              Continúa el Mapa con la Nutrición: descubre qué hay más allá de lo que comes cada día y aprende
              a alimentar tu cuerpo —y tu claridad mental— con lo que de verdad te sostiene.
            </Text>
