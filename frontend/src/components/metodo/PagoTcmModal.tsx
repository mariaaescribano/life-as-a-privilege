...
/** Pago de la 4ª disciplina (Medicina China). Mismo lenguaje que PagoAyurvedaModal. */
export function PagoTcmModal({ isOpen, onClose, onPagar, loading, error, onTest }: PagoTcmModalProps) {
  return (
