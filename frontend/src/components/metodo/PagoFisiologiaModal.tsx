...
interface PagoFisiologiaModalProps {
  isOpen: boolean;
  onClose: () => void;
  onPagar: () => void;
  loading?: boolean;
...
/** Pago de la 5ª disciplina (Fisiología). Mismo lenguaje que PagoTcmModal. */
export function PagoFisiologiaModal({ isOpen, onClose, onPagar, loading, error, onTest }: PagoFisiologiaModalProps) {
  return (
        ...
        <ModalBody px={{ base: 7, md: 10 }} py={{ base: 8, md: 10 }}>
          <Flex direction="column" gap={5}>
            ...
            <Text
              ...
              textAlign="center"
            >
              Continúa el Mapa con la Fisiología: viaja desde las partículas que te forman hasta el milagro
              de ser un cuerpo vivo, y redescúbrete como la maravilla que eres.
            </Text>
