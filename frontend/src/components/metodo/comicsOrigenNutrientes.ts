...
export const ORIGEN_NUTRIENTES: LecturaOrigen[] = [
  {
    ...
    resumen: "Tus átomos son prestados.",
  ...
  },
  {
    ...
    resumen: "La planta absorbe los minerales que antes eran de una roca.",
  ...
  },
  {
    ...
    titulo: "El interior de una planta",
    resumen: "El ser que hace posible la existencia del resto.",
  ...
  },
  {
    ...
    titulo: "Los adentros de una hoja",
    resumen: "Los creadores de la glucosa y el oxígeno.",
    cover: portada("hoja"),
    emoji: "",
  ...
  },
  {
    ...
    titulo: "Los colores de los alimentos",
    resumen: "Comemos flores.",
    cover: portada("fruta"),
    emoji: "",
  ...
  },
  {
    ...
    titulo: "El viaje de un nutriente por un animal",
    resumen: "Cómo los nutrientes pasan de un ser a otro y qué ocurre por el camino.",
