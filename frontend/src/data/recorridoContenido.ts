...
> = {
  ...
  astrologia: {
    ...
    modalDesc:
      "Tu carta natal no predice tu futuro: describe cómo estás configurado. Qué partes tuyas tienen más peso, qué tensiones internas arrastras, qué te cuesta y qué te sale solo. Es el primer paso del recorrido porque sin saber de dónde partes, cualquier trabajo posterior va a ciegas.",
    contenido: [
      {
