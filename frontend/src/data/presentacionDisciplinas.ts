...
const base: Record<string, PresentacionDisciplina> = {
  astrologia: {
    ...
    txt: astrologiaTxt,
    Icon: AstrologiaIcon,
    gancho: "Tu carta natal no predice. Te describe.",
  ...
  psicologia: {
    ...
    gancho: "Lo que no nombras, te maneja.",
  ...
  ayurveda: {
    ...
    txt: ayurvedaTxt,
    Icon: AyurvedaIcon,
    gancho: "No hay una dieta buena. Hay una dieta tuya.",
  ...
  tcm: {
    ...
    txt: tcmTxt,
    Icon: TCMIcon,
    gancho: "Tu cuerpo lleva años avisándote. En otro idioma.",
  ...
  fisiologia: {
    ...
    txt: fisiologiaTxt,
    Icon: FisiologiaIcon,
    gancho: "Billones de células trabajando para ti ahora mismo.",
  ...
  nutricion: {
    ...
    txt: nutricionTxt,
    Icon: NutricionIcon,
    gancho: "No eres lo que comes. Eres lo que absorbes.",
  ...
  cabala: {
    ...
    txt: cabalaTxt,
    Icon: CabalaIcon,
    gancho: "Diez formas de ser. Un solo árbol.",
  ...
  cultura: {
    ...
    txt: culturaTxt,
    Icon: CulturaIcon,
    gancho: "Has aprendido siete formas de mirar. Construye la tuya.",
