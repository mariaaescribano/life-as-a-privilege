...
import { neuropsicologiaBg, NeuropsicologiaIcon, neuropsicologiaTxt, AstrologiaIcon, AscendenteIcon, SunIcon, astrologiaNom, MoonIcon, RecursosIconAstrologia } from "../../../GlobalVariables";
import { astroCurso1ID } from "../../cursos/AstrologiaCursos";
import { 
...
export const modulosAstrologia: ModuloContenido[] = [
  ...
  },
  {
    ...
    submodules: [
      ...
      {
        id: "sol5", nom: "Sol en ♌︎ Leo", link: `${basePath}/sol5`, linkAnterior: `${basePath}/sol4`, linkNext: `${basePath}/sol6`, descripcion: "Un Sol en Leo es creativo y brillante, debe de reconocerse y dar Amor sin depender de otros.", video: "", letra: sol5, detalles: detalles, icon: SunIcon,
        cursoId: astroCurso1ID
      },
      {
