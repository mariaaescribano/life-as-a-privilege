...
import { tcmTxt, TCMIcon, tcmBg, CincoElementosIcon, RecursosIconTCM, MouthIcon, cabalaNom } from "../../../GlobalVariables";
import { letratcm1, letratcm10, letratcm11, letratcm12, letratcm13, letratcm14, letratcm15, letratcm16, letratcm17, letratcm18, letratcm19, letratcm2, letratcm20, letratcm21, letratcm22, letratcm23, letratcm24, letratcm3, letratcm4, letratcm5, letratcm6, letratcm7, letratcm8, letratcm9 } from "./LetraCabala";
...
export const modulostcm: ModuloContenido[] = [
  ...
  },
  {
    ...
    submodules: [
      { 
        id:"tcm21",
        nom: "5.1 El diagnóstico de la lengua",
        link:`${basePath}/tcm21`,
