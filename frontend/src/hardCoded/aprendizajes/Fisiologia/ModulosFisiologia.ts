...
import { fisio1, fisio2, fisio3, fisio4, fisio5, fisio6, fisio7, inflam1, inflam2, inflam3, inflam4, inflam5, inflam6, inflam7, inflam8, cancer1, cancer2, cancer3, cancer4, cancer5, cancer6, cancer7, cancer8, cancer9, med1, med2, med3, med4, med5, med6, med7 } from "./LetraFisiologia";
...
export const modulosFisiologiaCancer: ModuloContenido[] = [
  {
    ...
    submodules: [
      {
        id: "cancer1",
        nom: "1.1 Las células son inteligentes",
        link: `${basePath}/cancer1`,
        linkAnterior: "",
        linkNext: `${basePath}/cancer2`,
        descripcion: "La célula es un organismo vivo e inteligente capaz de regularse, adaptarse y reproducirse siguiendo el manual de su ADN.",
        video: "EMIxJ0mGaSY",
        letra: cancer1,
      ...
      {
        id: "cancer3",
        nom: "1.3 ¿Qué es el cáncer?",
        link: `${basePath}/cancer3`,
        linkAnterior: `${basePath}/cancer2`,
        linkNext: `${basePath}/cancer4`,
        descripcion: "El cáncer surge cuando las mutaciones genéticas apagan el mecanismo de corrección del ADN, dando paso a divisiones erróneas y tumores.",
        video: "VOcFsZMfzDg",
        letra: cancer3,
        cursoId: fisioCurso3ID,
        detalles: detalles,
  ...
  {
    title: "2. Cómo nace el cáncer",
    icon: InflamIcon,
    floatingButton: conocerMiCuerpo,
    submodules: [
      {
        id: "cancer4",
        nom: "2.1 Fumar en el cáncer",
        link: `${basePath}/cancer4`,
        linkAnterior: `${basePath}/cancer3`,
        linkNext: `${basePath}/cancer5`,
        descripcion: "Las sustancias tóxicas del tabaco alteran el ADN celular y dejan torpe al sistema inmunitario.",
        video: "Uxm_ohv5hjE",
        letra: cancer4,
        cursoId: fisioCurso3ID,
        detalles: detalles,
      ...
      {
        id: "cancer5",
        nom: "2.2 El alcohol en el cáncer",
      ...
      {
        id: "cancer6",
        nom: "2.3 La luz solar en el cáncer",
  ...
  },
  {
    ...
    submodules: [
      {
        id: "cancer7",
        nom: "3.1 El cáncer sabe esconderse",
        link: `${basePath}/cancer7`,
        linkAnterior: `${basePath}/cancer6`,
        linkNext: `${basePath}/cancer8`,
        descripcion: "Las células mutadas engañan al sistema inmunitario y producen sustancias que suprimen la respuesta inmune.",
        video: "HOXvZ0-Is9k",
        letra: cancer7,
        cursoId: fisioCurso3ID,
        detalles: detalles,
      ...
      {
        id: "cancer8",
        nom: "3.2 La glucosa en el cáncer",
        link: `${basePath}/cancer8`,
        linkAnterior: `${basePath}/cancer7`,
        linkNext: `${basePath}/cancer9`,
        descripcion: "Las células mutadas crean nuevas arterias para robar nutrientes a las células sanas y alimentarse de glucosa.",
        video: "EifpcYAeebs",
        letra: cancer8,
        cursoId: fisioCurso3ID,
        detalles: detalles,
      ...
      {
        id: "cancer9",
        nom: "3.3 La nutrición en el cáncer",
        link: `${basePath}/cancer9`,
        linkAnterior: `${basePath}/cancer8`,
        linkNext: "",
        descripcion: "Cambiar la dieta a una rica en fibra, vitaminas, proteína vegetal y grasas insaturadas priva al cáncer de energía y refuerza al sistema inmunitario.",
        video: "zTdtLq2_NR8",
        letra: cancer9,
        cursoId: fisioCurso3ID,
        detalles: detalles,
