...
export const modulosFisiologiaMeditacion: ModuloContenido[] = [
  {
    title: "1. ¿Qué es meditar?",
    icon: SistemaNerviosoIcon,
    floatingButton: conocerMiCuerpo,
    submodules: [
      {
        id: "med1",
        nom: "1.1 La meditación y la respiración",
        link: `${basePath}/med1`,
        linkAnterior: "",
        linkNext: `${basePath}/med2`,
        descripcion: "Una práctica milenaria que cambia tu cerebro en tan solo 5 minutos al día: estar plenamente en el presente a través de tu respiración.",
        video: "LchHCxQYIu0",
        letra: med1,
      ...
      {
        id: "med2",
        nom: "1.2 Meditar es un reto intelectual",
        link: `${basePath}/med2`,
        linkAnterior: `${basePath}/med1`,
        linkNext: `${basePath}/med3`,
        descripcion: "Meditar no es relajarse: es una lucha contra tu propio ruido mental que entrena tu capacidad de atención cuando más la necesitas.",
        video: "5Rx0uC3jzVk",
        letra: med2,
        cursoId: fisioCurso4ID,
        detalles: detalles,
  ...
  },
  {
    ...
    submodules: [
      {
        id: "med3",
        nom: "2.1 Meditar te protege contra enfermedades",
        link: `${basePath}/med3`,
        linkAnterior: `${basePath}/med2`,
        linkNext: `${basePath}/med4`,
        descripcion: "Al meditar le mandas a tus células la señal de que estás a salvo: tu sistema inmunitario trabaja mejor y el cortisol se estabiliza.",
        video: "_t9JfxoboEw",
        letra: med3,
        cursoId: fisioCurso4ID,
        detalles: detalles,
  ...
  },
  {
    ...
    submodules: [
      {
        id: "med4",
        nom: "3.1 Meditar crea conexiones neuronales",
        link: `${basePath}/med4`,
        linkAnterior: `${basePath}/med3`,
        linkNext: `${basePath}/med5`,
        descripcion: "La neuroplasticidad refuerza las conexiones neuronales de la atención y hace que tu cerebro literalmente se haga más grande.",
        video: "7TEe3TYdWl0",
        letra: med4,
        cursoId: fisioCurso4ID,
        detalles: detalles,
      ...
      {
        id: "med5",
        nom: "3.2 Meditar hace más grande tu cerebro",
        link: `${basePath}/med5`,
        linkAnterior: `${basePath}/med4`,
        linkNext: `${basePath}/med6`,
        descripcion: "La corteza prefrontal — la zona que razona, planifica y controla los impulsos — crece con la meditación, haciéndote más eficaz y productivo.",
        video: "9Ohs0xaxwYU",
        letra: med5,
        cursoId: fisioCurso4ID,
        detalles: detalles,
      ...
      {
        id: "med6",
        nom: "3.3 Meditar reduce el enfado",
        link: `${basePath}/med6`,
        linkAnterior: `${basePath}/med5`,
        linkNext: `${basePath}/med7`,
        descripcion: "Cuando meditas, tu amígdala reduce su tamaño: aumenta tu tolerancia y disminuye tu reactividad al estrés y a los fantasmas del pasado.",
        video: "RmZ-DCFZs4s",
        letra: med6,
        cursoId: fisioCurso4ID,
        detalles: detalles,
      ...
      },
      {
        ...
        linkNext: "",
        descripcion: "El hipocampo crece con la meditación, mejorando la memoria a largo plazo. Harvard demostró que basta con 2 meses de práctica diaria.",
        video: "PsMOpQ2jl4Y",
        letra: med7,
        cursoId: fisioCurso4ID,
        detalles: detalles,
