...
import { fisio1, fisio2, fisio3, fisio4, fisio5, fisio6, fisio7, inflam1, inflam2, inflam3, inflam4, inflam5, inflam6, inflam7, inflam8, cancer1, cancer2, cancer3, cancer4, cancer5, cancer6, cancer7, cancer8, cancer9, cancer10, cancer11 } from "./LetraFisiologia";
...
export const modulosFisiologiaCancer: ModuloContenido[] = [
  ...
  {
    title: "3. Sistema inmunitario y cáncer",
    icon: SistemaNerviosoIcon,
    floatingButton: conocerMiCuerpo,
    submodules: [
      {
  ...
  {
    title: "4. Angiogénesis y crecimiento tumoral",
    icon: CelulasOrganosIcon,
    floatingButton: conocerMiCuerpo,
    submodules: [
      {
  ...
  {
    title: "5. Metabolismo de las células cancerosas",
    icon: CelulasOrganosIcon,
    floatingButton: conocerMiCuerpo,
    submodules: [
      {
  ...
  {
    title: "6. Nutrición y cáncer",
    icon: MilagroIcon,
    floatingButton: conocerMiCuerpo,
    submodules: [
      {
        id: "cancer10",
        nom: "6.1 Por qué la bollería incrementa el cáncer",
  ...
  {
    title: "8. Ejercicio y fuerza",
    icon: MilagroIcon,
    floatingButton: conocerMiCuerpo,
    submodules: [
      {
        id: "cancer11",
        nom: "8.1 Las personas con cáncer tienen que ir al gimnasio",
