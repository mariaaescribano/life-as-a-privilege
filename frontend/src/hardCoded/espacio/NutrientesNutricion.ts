...
export const NUTRIENTES: Nutriente[] = [
  ...
  },
  {
    ...
    descripcion: [
      "Esto no es un nutriente. Un nutriente entra, se rompe y se convierte en ti: en membrana, en enzima, en energía. Una droga entra, se sienta en una cerradura que ya tenías, deja un mensaje que tu cuerpo no había pedido y se va. Nada de ella se queda formando parte de ti.",
    ...
    tarjetas: [
      {
        ...
        claves: [
          "No cura el daño: apaga dolor, fiebre e inflamación",
          "Bloquea las enzimas COX",
          "También quita protección al estómago y al riñón",
        ],
        parrafos: [
          "Cuando un tejido se daña, produce ácido araquidónico, que las enzimas COX convierten en prostaglandinas. Estas producen dolor, fiebre e inflamación.",
          "El ibuprofeno bloquea las enzimas COX y reduce esos síntomas, pero el daño sigue ahí: solo ha silenciado la señal.",
          "El problema es que COX-1 también protege el estómago, mantiene el riego del riñón y participa en la coagulación. El ibuprofeno bloquea ambas COX, así que puede causar gastritis, úlceras y problemas renales, sobre todo con deshidratación o uso prolongado.",
          "A largo plazo también puede favorecer retención de agua y sodio, empeorar la tensión y aumentar el riesgo cardiovascular. Es un buen medicamento; el problema es usarlo todos los días «por si acaso».",
        ],
      },
      {
        key: "paracetamol",
        ...
        claves: [
          ...
          "Actúa sobre todo en el cerebro",
          "El exceso puede destruir el hígado",
        ],
        parrafos: [
          "El paracetamol reduce dolor y fiebre, pero apenas actúa sobre la inflamación. Su mecanismo exacto no está del todo claro, aunque parece actuar sobre COX en el cerebro y sobre otros sistemas del dolor.",
          "El problema está en el hígado. La mayoría se transforma en moléculas fáciles de eliminar, pero un 5-10 % se convierte en NAPQI, un metabolito muy tóxico.",
          "El glutatión lo neutraliza. Pero si tomas demasiado, consumes alcohol crónicamente, estás desnutrido o llevas mucho tiempo en ayunas, puedes quedarte sin suficiente glutatión. Entonces el NAPQI empieza a destruir células del hígado.",
          "Por eso una sobredosis puede provocar fallo hepático grave. Además, muchos medicamentos para el resfriado ya llevan paracetamol, así que es fácil sumar dosis sin darse cuenta.",
          "El antídoto es N-acetilcisteína, que permite al hígado recuperar glutatión.",
        ],
      },
      {
        key: "marihuana",
        ...
        claves: [
          "Tu cerebro ya fabrica sus propios cannabinoides",
          "El THC activa ese sistema en todo el cerebro durante horas",
          "El cerebro se adapta quitando receptores",
        ],
        parrafos: [
          "Tu cerebro fabrica cannabinoides como anandamida y 2-AG. Funcionan como un freno: la neurona que recibe una señal manda un mensaje hacia atrás para decirle a la otra «baja el volumen». Regulan apetito, dolor, ansiedad, sueño y memoria.",
          "Normalmente este sistema es local, preciso y breve: se fabrica cuando hace falta y desaparece en segundos.",
          "El THC activa el mismo receptor, CB1, pero llega por la sangre y activa el sistema por todo el cerebro durante horas. Por eso afecta a muchas funciones a la vez.",
          "Hay muchos CB1 en el hipocampo, por eso puede dificultar formar recuerdos; en la corteza prefrontal, afectando atención y control de impulsos; en cerebelo y ganglios basales, empeorando coordinación y tiempo de reacción; y en el hipotálamo, aumentando el hambre.",
          "Con el consumo repetido, el cerebro se defiende reduciendo los receptores CB1. Aparece tolerancia y, al dejarlo, pueden aparecer irritabilidad, insomnio, sueños intensos y falta de apetito. Los receptores pueden recuperarse después de unas semanas.",
          "En un cerebro todavía en desarrollo, el consumo intenso y temprano se asocia con peor memoria y atención y mayor riesgo de psicosis en personas predispuestas.",
          "Y si se fuma, además está el humo: alquitrán, monóxido de carbono e irritación pulmonar. El THC también se almacena en la grasa y se libera lentamente durante días o semanas.",
        ],
      },
      {
        key: "tabaco",
        ...
        claves: [
          "La nicotina engancha; el humo causa la mayor parte del daño",
          "El cerebro fabrica más receptores y aparece el ansia",
          "Al dejarlo, el cuerpo empieza a recuperarse rápidamente",
        ],
        parrafos: [
          "La nicotina es la que crea dependencia; el humo contiene los carcinógenos que causan gran parte del daño.",
          "La nicotina activa los receptores de acetilcolina y llega al cerebro en unos diez segundos, provocando dopamina en el circuito de recompensa. Al repetirlo muchas veces, el cerebro fabrica más receptores para adaptarse.",
          "Cuando baja la nicotina, esos receptores quedan vacíos y aparece el ansia. Por eso muchas veces el cigarro no da placer: simplemente elimina la abstinencia.",
          "El humo contiene monóxido de carbono, que se une a la hemoglobina mucho mejor que el oxígeno. También daña el endotelio de las arterias, aumenta la formación de placas y coágulos y favorece infartos, ictus y problemas de circulación.",
          "En los pulmones destruye los cilios que limpian las vías respiratorias y daña los alvéolos, pudiendo producir EPOC. Sus carcinógenos también dañan el ADN y aumentan progresivamente el riesgo de cáncer.",
          "Además, consume antioxidantes, acelera el envejecimiento de la piel, empeora los huesos, la cicatrización y la sensibilidad a la insulina.",
          "La buena noticia: al dejarlo, el cuerpo empieza a reparar. El monóxido desaparece en horas, gusto y olfato mejoran en días, los cilios se recuperan en semanas o meses y el riesgo cardiovascular cae mucho durante el primer año.",
        ],
      },
      {
        key: "vaper",
        ...
        claves: [
          "Sin combustión: menos dañino que fumar, pero no inocuo",
          "Las sales de nicotina permiten consumir mucha más",
          "El aerosol contiene sustancias irritantes y metales",
        ],
        parrafos: [
          "El vaper no quema tabaco: calienta una mezcla de propilenglicol, glicerina, nicotina y aromas. Por eso produce mucho menos alquitrán y monóxido de carbono que un cigarro. Para alguien que fuma y cambia completamente al vaper, es menos dañino, pero no es inocuo.",
          "Las sales de nicotina permiten inhalar concentraciones muy altas sin que la garganta arda tanto. Al quitar ese freno, puedes consumir nicotina muchas veces durante todo el día y desarrollar dependencia rápidamente.",
          "El aerosol tampoco es simplemente vapor de agua. Al calentarse puede producir formaldehído, acetaldehído y acroleína, además de liberar metales como níquel, cromo, estaño y plomo.",
          "En los pulmones puede producir estrés oxidativo, inflamación, alterar los cilios y debilitar las defensas frente a infecciones. También se ha observado alteración de la función vascular.",
          "Los aromas están menos estudiados y algunas sustancias pueden ser seguras al comerlas pero dañinas al calentarlas e inhalarlas.",
          "En 2019 apareció el EVALI, una lesión pulmonar grave relacionada principalmente con acetato de vitamina E en cartuchos ilegales de THC.",
          "En resumen: para dejar de fumar puede ser una opción menos dañina; empezar a vapear sin fumar es empezar una dependencia innecesaria. Y todavía no sabemos qué efectos tendrá a 30 años porque no han pasado 30 años.",
        ],
      },
      {
        key: "cafeina",
        ...
        claves: [
          "No da energía: bloquea la señal de cansancio",
          "Ocupa los receptores de adenosina",
          "Puede crear un círculo de peor sueño → más café",
        ],
        parrafos: [
          "La cafeína no aporta energía: bloquea la sensación de cansancio.",
          "Mientras estás despierto, se acumula adenosina, un producto del gasto de ATP. La adenosina se une a sus receptores y le dice al cerebro que empiece a bajar el ritmo.",
          "La cafeína tiene una estructura parecida y ocupa esos receptores sin activarlos. Es un tapón: la adenosina sigue acumulándose, pero no puede transmitir el mensaje.",
          "Al bloquearla aumentan la alerta, el foco y algo la actividad de dopamina y noradrenalina. También puede estrechar los vasos cerebrales, por eso ayuda en algunas migrañas y puede provocar dolor de cabeza al dejarla.",
          "Con el consumo habitual, el cerebro fabrica más receptores de adenosina. Aparece tolerancia: necesitas más cafeína para conseguir el mismo efecto y, sin ella, te notas peor.",
          "Además, la cafeína tiene una vida media de unas 4-6 horas. Un café a las 17:00 puede dejar aproximadamente la mitad de la dosis en sangre a medianoche. Puedes dormirte y aun así perder sueño profundo.",
          "Entonces aparece el círculo: duermes peor → estás más cansado → tomas más café.",
          "La referencia habitual para un adulto sano es unos 400 mg al día, aunque menos durante el embarazo. Las bebidas energéticas son otro escenario porque concentran mucha cafeína y suelen consumirse rápidamente.",
          "El café en sí contiene polifenoles y se asocia con beneficios para la salud. El problema es usarlo para tapar una deuda de sueño que solo se puede pagar durmiendo.",
        ],
      },
    ],
  },
