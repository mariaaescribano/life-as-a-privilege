...
import { CabalaIcon } from "../../GlobalVariables";

export const preguntasCabala: Bloque[] = [
  {
    title: "Keter — Corona",
    icon: CabalaIcon,
    subPreguntas: [
      {
        ...
        consejo: "Keter nos recuerda que existe una voluntad mayor detrás de cada experiencia. No tienes que entenderlo todo para confiar en ello.",
      },
      {
  ...
  {
    title: "Chokmah — Sabiduría",
    icon: CabalaIcon,
    subPreguntas: [
      {
        idPregunta: "cab_chokmah_1",
        pregunta: "¿Confías en tu intuición? ¿Recuerdas alguna vez que la ignoraste y pagaste las consecuencias?",
  ...
  {
    title: "Binah — Entendimiento",
    icon: CabalaIcon,
    subPreguntas: [
      {
        idPregunta: "cab_binah_1",
        pregunta: "¿Puedes dar estructura y límites sanos a lo que amas? ¿O tiendes a desbordarte o a cerrarte por completo?",
        consejo: "Binah no niega el amor, lo sostiene. Los límites son la forma que toma el cuidado cuando es verdadero.",
      },
      {
