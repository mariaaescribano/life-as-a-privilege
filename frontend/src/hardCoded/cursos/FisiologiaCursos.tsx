...
import { fisioCurso1ID, fisioCurso2ID, fisioCurso3ID, modulosFisiologia, modulosFisiologiaInflamacion, modulosFisiologiaCancer } from "../aprendizajes/Fisiologia/ModulosFisiologia";
