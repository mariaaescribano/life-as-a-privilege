...
// con un mini-parser en MetodoAyurvedaDoshaIntro).

export type DoshaKey = "vata" | "pitta" | "kapha";

// Clave de icono (lucide) para cada ítem de «Lo que descubrirás».
export type DescubreIcon = "mente" | "cuerpo" | "habitos" | "alimentacion" | "equilibrio" | "dones";
...
export interface DoshaIntro {
  ...
  descubriras: { titulo: string; intro: string; items: { icon: DescubreIcon; texto: string }[] };
  /** Pregunta final de texto libre (se guarda en BD). */
...
export const DOSHA_INTRO: Record<DoshaKey, DoshaIntro | null> = {
  vata: {
    ...
    descubriras: {
      ...
      items: [
        { icon: "mente", texto: "**Cómo piensa una persona Vata.**" },
        { icon: "cuerpo", texto: "**Por qué tu cuerpo funciona como funciona.**" },
        { icon: "habitos", texto: "**Qué hábitos aumentan o equilibran tu naturaleza.**" },
        { icon: "alimentacion", texto: "**Qué alimentación favorece tu bienestar.**" },
        { icon: "equilibrio", texto: "**Cómo recuperar el equilibrio cuando sientes que te estás dispersando.**" },
        { icon: "dones", texto: "**Y descubrirás que muchas de las cosas que hoy consideras defectos pueden convertirse en algunos de tus mayores dones.**" },
      ],
    },
    preguntaFinal: {
  ...
  pitta: {
    ...
    descubriras: {
      ...
      intro: "A lo largo de este camino comprenderás:",
      items: [
        { icon: "mente", texto: "**Cómo piensa una persona Pitta.**" },
        { icon: "cuerpo", texto: "**Por qué tu cuerpo funciona como funciona.**" },
        { icon: "habitos", texto: "**Qué hábitos aumentan o equilibran tu fuego interior.**" },
        { icon: "alimentacion", texto: "**Qué alimentación favorece tu bienestar.**" },
        { icon: "equilibrio", texto: "**Cómo mantener tu capacidad de liderazgo sin caer en el exceso de exigencia.**" },
        { icon: "dones", texto: "**Y descubrirás que aquello que hoy puede agotarte también puede convertirse en una de tus mayores fortalezas.**" },
      ],
    },
    preguntaFinal: {
      titulo: "Una última pregunta antes de empezar…",
  ...
  kapha: {
    ...
    descubriras: {
      ...
      intro: "A lo largo de este camino comprenderás:",
      items: [
        { icon: "mente", texto: "**Cómo piensa una persona Kapha.**" },
        { icon: "cuerpo", texto: "**Por qué tu cuerpo funciona como funciona.**" },
        { icon: "habitos", texto: "**Qué hábitos aumentan o equilibran tu naturaleza.**" },
        { icon: "alimentacion", texto: "**Qué alimentación favorece tu bienestar.**" },
        { icon: "equilibrio", texto: "**Cómo mantener tu calma sin caer en el estancamiento.**" },
        { icon: "dones", texto: "**Y descubrirás que aquello que hoy puede parecer una limitación también es una de tus mayores fortalezas.**" },
      ],
    },
    preguntaFinal: {
      titulo: "Una última pregunta antes de empezar…",
