...
// antes de los Cursos.
//
// Las siete cajas colocadas como están en el cuerpo: la corona ARRIBA DEL
// TODO, ancha, y debajo tres filas de dos, bajando hasta la raíz.
//
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // El mapa no se enseña hasta que estén los siete mandalas: si no, las
        // cajas van apareciendo a trozos.
        await precargarImagenes(
          CHAKRAS_LISTA.map((c) => encodeURI(chakraFoto(c.key))),
        );
      } catch {
    ...
    <Box minH="100vh" display="flex" flexDirection="column" bg="#008080" fontFamily="'EB Garamond', serif">
      ...
      <Flex flex="1" justify="center" px={{ base: 5, md: 10, lg: 16 }} pt={{ base: 8, md: 12 }} pb={{ base: 14, md: 20 }}>
        <Flex direction="column" align="center" w="100%" maxW="1150px" gap={{ base: 6, md: 8 }}>
          ...
          <Flex w="100%" direction="column" gap={{ base: 4, md: 5 }}>
