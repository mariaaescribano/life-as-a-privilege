...
import { useDoshaDescubre } from "../../hardCoded/metodo/useDoshaContenido";
      ...
      <Flex flex="1" justify="center" px={{ base: 5, md: 10, lg: 16 }} pt={{ base: 8, md: 12 }} pb={{ base: 14, md: 20 }}>
        <Flex direction="column" align="center" w="100%" maxW="820px" gap={{ base: 6, md: 7 }}>
          ...
          <MetodoStepHeader
            ...
            extra={ilustracionesBtn}
            next={{ label: `${t("metodo.ayur.paso.cuerpo")} →`, onClick: irSiguiente, disabled: !guardado, disabledTooltip: t("metodo.ayur.guardaRespuestaCorto") }}
          />
          </Reveal>
