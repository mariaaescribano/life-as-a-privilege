...
const Home = () => {
  ...
  const aprendizajes = [
    ...
    },
    {
      ...
      linkAprendizaje: "/aprendizaje/modulosPage/neuropsicologia",
      linkEspacio: "/aprendizaje/modulosPage/neuropsicologia"
    },
    {
      title: astrologiaNom,
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          <Box w={{ sm:"80%", md: "100%" }} display="flex" justifyContent="center">
            <PhotoMandala />
          </Box>
