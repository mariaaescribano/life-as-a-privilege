...
>
  ...
  >
    <FeatureCard
      ...
      description="Explora un mundo de posibilidades donde la naturaleza se encuentra con la creatividad. Cada momento capturado cuenta una historia única y especial."
    />
  </SimpleGrid>
</Grid>
