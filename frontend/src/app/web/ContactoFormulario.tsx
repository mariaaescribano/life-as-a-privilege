/**
 * ESCRIBIRME (/contacto/escribir).
 *
 * El formulario, en su propia página: se llega desde la tarjeta
 * «Escríbeme» de /contacto. Antes colgaba debajo de las tarjetas y había
 * que bajar hasta él.
 */
