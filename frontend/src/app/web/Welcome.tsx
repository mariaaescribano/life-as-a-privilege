...
const Welcome = () => {
  ...
  return (
    ...
    >
      ...
      {/* ── BOTÓN «EL MAPA» ──
          Corta la página entre las disciplinas y la creadora. Va después de las
          tarjetas a propósito: arriba todavía no se sabe qué son las ocho
          disciplinas, y un botón al Mapa antes de verlas no dice nada. */}
      <OpinionesSection />
