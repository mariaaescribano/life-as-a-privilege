...
const COURSE_ORDER: { modalidadKey: string; cursoId: string }[] = [
  { modalidadKey: neuropsicologiaNom,    cursoId: "padresHeridos"   },
  { modalidadKey: nutricionNomLink,      cursoId: "nut-curso-2"     },
  { modalidadKey: fisiologiaNom,         cursoId: "fisio-curso-4"   },
