...
const BotanicalCorner = ({ flip = false }: { flip?: boolean }) => (
  ...
  >
    <svg width="170" height="170" viewBox="0 0 170 170" fill="none">
      <path d="M 10 160 C 22 124 55 88 90 58 C 118 34 142 18 162 8" stroke={nutricionBg} strokeWidth="2.2" strokeLinecap="round"/>
      <path d="M 30 136 C 10 122 8 102 22 92 C 40 104 44 124 30 136 Z" fill={nutricionBg}/>
      <path d="M 30 136 C 24 116 18 98 22 92" stroke={nutricionBg} strokeWidth="0.9" fill="none"/>
      <path d="M 58 108 C 72 92 74 72 60 62 C 44 72 42 92 58 108 Z" fill={nutricionBg}/>
      <path d="M 58 108 C 56 90 54 74 60 62" stroke={nutricionBg} strokeWidth="0.9" fill="none"/>
      <path d="M 88 78 C 72 64 70 46 84 38 C 102 48 104 66 88 78 Z" fill={nutricionBg}/>
      <path d="M 88 78 C 82 62 80 48 84 38" stroke={nutricionBg} strokeWidth="0.9" fill="none"/>
      <path d="M 118 50 C 130 36 134 18 120 10 C 104 18 100 36 118 50 Z" fill={nutricionBg}/>
      <path d="M 118 50 C 116 34 114 20 120 10" stroke={nutricionBg} strokeWidth="0.9" fill="none"/>
      <circle cx="10" cy="158" r="5.5" fill={nutricionBg}/>
      <circle cx="5"  cy="148" r="4"   fill={nutricionBg}/>
      <circle cx="18" cy="149" r="4"   fill={nutricionBg}/>
      <circle cx="6"  cy="138" r="2.5" fill={nutricionBg} opacity="0.7"/>
      <circle cx="162" cy="9"  r="4"   fill={nutricionBg}/>
      <circle cx="158" cy="4"  r="2.8" fill={nutricionBg} opacity="0.8"/>
      <circle cx="167" cy="5"  r="2.5" fill={nutricionBg} opacity="0.7"/>
    </svg>
  </Box>
);
...
const BeeDecoration = ({ size = 52, opacity = 0.13, style = {} }: { size?: number; opacity?: number; style?: React.CSSProperties }) => (
  <Box position="absolute" pointerEvents="none" zIndex={0} style={{ opacity, ...style }}>
    <svg width={size} height={size} viewBox="0 0 52 52" fill="none">
      <ellipse cx="16" cy="19" rx="11" ry="6" fill={nutricionBg} opacity={0.55} transform="rotate(-30 16 19)"/>
      <ellipse cx="36" cy="19" rx="11" ry="6" fill={nutricionBg} opacity={0.55} transform="rotate(30 36 19)"/>
      <ellipse cx="26" cy="32" rx="9" ry="12" fill={nutricionBg}/>
      ...
      <circle cx="26" cy="19" r="6" fill={nutricionBg}/>
      <circle cx="23.5" cy="18.5" r="1.2" fill="white" opacity={0.7}/>
      <circle cx="28.5" cy="18.5" r="1.2" fill="white" opacity={0.7}/>
      <path d="M23 14 C21 10 17 8 16 5" stroke={nutricionBg} strokeWidth="1.6" strokeLinecap="round"/>
      <circle cx="15.5" cy="4.5" r="2.2" fill={nutricionBg}/>
      <path d="M29 14 C31 10 35 8 36 5" stroke={nutricionBg} strokeWidth="1.6" strokeLinecap="round"/>
      <circle cx="36.5" cy="4.5" r="2.2" fill={nutricionBg}/>
      <path d="M26 44 L24 49 L26 47 L28 49 Z" fill={nutricionBg}/>
    </svg>
  </Box>
);
