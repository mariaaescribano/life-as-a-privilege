/**
 * Physiology · The Map — page text, in ENGLISH.
 *
 * Whatever is missing here falls back to Spanish on its own.
 *
 * Careful with the numbers: the Spanish «billón» is 10¹², so «37 billones de
 * células» is *37 trillion cells* in English, not 37 billion.
 */
export const fisiologia = {
  // ── Step titles ────────────────────────────────────────────────────────
  "fisiologia.particulas.titulo": "Particles",
  "fisiologia.atomos.titulo": "Atoms",
  "fisiologia.moleculas.titulo": "Molecules",
  "fisiologia.macromoleculas.titulo": "Macromolecules",
  "fisiologia.estructuras.titulo": "Cell structures",
  "fisiologia.estructuras.corto": "Structures",
  "fisiologia.celula.titulo": "Cell",
  "fisiologia.lasCelulas.titulo": "The cells of your organs",
  "fisiologia.lasCelulas.corto": "The cells",
  "fisiologia.tejidos.titulo": "Tissues",
  ...
  "fisiologia.profundiza.titulo": "Go deeper",
  "fisiologia.cursos.titulo": "Physiology courses",
  ...
  "fisiologia.niveles.entrar": "Enter",
  "fisiologia.niveles.superado": "Completed",
  "fisiologia.niveles.materia": "MATTER",
  "fisiologia.niveles.materia.sub": "What you're made of.",
  "fisiologia.niveles.vida": "LIFE",
  "fisiologia.niveles.vida.sub": "The miracle of being a body.",
  "fisiologia.niveles.profundiza": "GO DEEPER",
  "fisiologia.niveles.profundiza.sub": "For those who want the whole truth.",

  // ── Particles ──────────────────────────────────────────────────────────
  "fisiologia.particulas.instruccion": "Build a particle.",
  "fisiologia.particulas.bloqueo": "Build the particle first",
  "fisiologia.particulas.nucleo": "the nucleus",
  ...
  "fisiologia.pieza.proton": "proton",
  "fisiologia.pieza.neutron": "neutron",
  "fisiologia.pieza.electron": "electron",

  // ── Atoms ──────────────────────────────────────────────────────────────
  "fisiologia.atomos.instruccionGeneral": "Build a {atomo} atom.",
  "fisiologia.atomos.bloqueo": "Build both atoms first",
  "fisiologia.atomos.nucleo": "the nucleus",
  "fisiologia.atomos.formandose": "…forming…",
  "fisiologia.atomos.siguiente": "Now, Helium →",
  "fisiologia.atomos.hidrogeno": "Hydrogen",
  "fisiologia.atomos.hidrogeno.instruccion":
  ...
  "fisiologia.moleculas.ahora": "Now, {molecula} →",
  "fisiologia.moleculas.verLasTres": "See the molecules of Life →",
  "fisiologia.moleculas.instruccionGeneral":
    "A molecule is atoms joined together. Form a molecule of {molecula}.",
  "fisiologia.pieza.hidrogeno": "hydrogen",
  "fisiologia.pieza.oxigeno": "oxygen",
  "fisiologia.pieza.carbono": "carbon",
  "fisiologia.moleculas.agua": "water",
  "fisiologia.moleculas.agua.articulo": "water",
  "fisiologia.moleculas.agua.instruccion":
  ...
  "fisiologia.moleculas.o2.hecho": "You've formed an oxygen molecule!",
  "fisiologia.moleculas.o2.p1":
    "Every cell needs it to **turn food into energy**. Without it, Life as you know it wouldn't exist.",
  ...
  "fisiologia.macro.verDeNuevo": "Formed · see it again",
  "fisiologia.macro.construir": "Build · {n} {monomeros}",
  ...
  "fisiologia.macro.adn.monomero": "nucleotide",
  "fisiologia.macro.adn.monomeroPl": "nucleotides",
  ...
  "fisiologia.pieza.fosfato": "phosphate",
  "fisiologia.pieza.glicerol": "glycerol",
  "fisiologia.pieza.grasaSaturada": "saturated fatty acid",
  "fisiologia.pieza.grasaInsaturada": "unsaturated fatty acid",

  // ── Cell structures ────────────────────────────────────────────────────
  "fisiologia.estructuras.intro":
    "Proteins, DNA and lipids assemble to form the parts of the cell. Build all four.",
  "fisiologia.estructuras.instruccion": "Drag the macromolecules into the zone to assemble it.",
  "fisiologia.estructuras.bloqueo": "Build the four structures first",
  "fisiologia.estructuras.volver": "The 4 structures",
  "fisiologia.estructuras.zona": "assembly zone",
  "fisiologia.estructuras.organizandose": "…organizing…",
  "fisiologia.estructuras.construida": "Built",
  "fisiologia.estructuras.verDeNuevo": "Built · see it again",
  "fisiologia.estructuras.construir": "Build",
  "fisiologia.est.nucleo": "Nucleus",
  "fisiologia.est.nucleo.desc": "It keeps and protects your genetic information.",
  ...
  "fisiologia.est.mitocondria.r1":
    "With its folded membranes and a great many proteins and enzymes, the mitochondrion turns nutrients and oxygen into energy.",
  "fisiologia.est.mitocondria.r2":
    "It's the power plant that makes ATP, the fuel that keeps every process in your body running.",
  ...
  "fisiologia.estructuras.crearCelula": "Create the cell →",
  ...
  "fisiologia.pieza.enzimas": "Enzymes",

  // ── Cell ───────────────────────────────────────────────────────────────
  "fisiologia.celula.instruccion": "Build a cell.",
  "fisiologia.celula.zona": "the cytoplasm",
  "fisiologia.celula.hecho": "You've built a cell!",
  "fisiologia.celula.p1":
    "A **cell** is the smallest unit with a Life of its own: inside its membrane, the nucleus keeps the DNA with the instructions, the ribosomes make proteins and the mitochondria generate energy.",
  ...
  "fisiologia.pieza.ribosoma": "ribosome",
  "fisiologia.pieza.celula": "cell",
  "fisiologia.pieza.tejido": "tissue",
  ...
  "fisiologia.lasCelulas.sinDescripcion": "Description of the {organo} (coming soon).",
  "fisiologia.lasCelulas.sinCelulas": "Soon you'll be able to explore this organ's cells.",
  "fisiologia.lasCelulas.enDetalle": "In detail",
  "fisiologia.lasCelulas.sinConsejos": "Tips for taking care of your {organo} (coming soon)",
  "fisiologia.lasCelulas.leerMas": "Read more →",
  "fisiologia.lasCelulas.leerDeNuevo": "Read it again →",
  "fisiologia.lasCelulas.leida": "Read",
  "fisiologia.lasCelulas.consejoAnterior": "Previous tip",
  "fisiologia.lasCelulas.consejoSiguiente": "Next tip",

  // ── Tissues and organs ─────────────────────────────────────────────────
  "fisiologia.tejidos.introTitulo": "Form a tissue",
  "fisiologia.tejidos.instruccion": "Gather several identical cells to form a tissue.",
  "fisiologia.tejidos.zona": "group the cells",
  "fisiologia.tejidos.hecho": "You've formed a tissue!",
  ...
  "fisiologia.organos.hecho": "You've formed an organ!",
  ...
  // ── The body ───────────────────────────────────────────────────────────
  "fisiologia.organismo.instruccion": "Build a human being.",
  "fisiologia.organismo.zona": "its place in the body",
  "fisiologia.organismo.hecho": "You've built a human being.",
  ...
  "fisiologia.organismo.alt": "A human being",
